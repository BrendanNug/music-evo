  ...
  function MIDI(arg, increase = 0) {
    ...
    for (i = 0; i < arr.length; i++) {
      ...
      if (i == 1) {
        ...
        // if (n+increase > 255) increase = -1*n + (n+increase - 255); 
        console.log("program is " + n)
        if (self[0] >= 0xC0 && self[0] <= 0xCF) n = MIDI.programValue(n+increase);
      }
